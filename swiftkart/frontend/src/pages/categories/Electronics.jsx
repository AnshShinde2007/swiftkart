  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Filter products based on Electronics
        const filteredProducts = productResponse.data.filter(product => product.category === "Electronics");
            ...
            <div className="col" key={product._id}>
              <Card className="shadow-sm rounded-lg border-0">
                ...
                <Card.Body className="text-center">
                  ...
                  <Card.Text className="text-muted">{product.Electronics}</Card.Text>
